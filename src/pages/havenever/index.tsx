  ...
  return (
    <div className="h-screen bg-background">
      <div className="relative flex h-20 justify-center p-2">
        <h1 className="m-0 text-center text-3xl text-white">Je n'ai jamais</h1>
        <Link
      ...
      <div className="game-container hide-scroll-bar flex flex-col gap-6 overflow-y-auto p-3">
        <div className="border-1 flex w-full items-center gap-5 overflow-auto whitespace-nowrap p-2 px-3">
